				...
				<div class="box-container">
                    <div class="single-content popup-content" id="target-id">
                        ...
                        <p>
                            ...
                            <a href="#" class="button button-red">Button Orange</a>
                        </p>
                        <p>Struktur HTML:</p>
                        <div class="highlight">
...
<span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">class=</span><span class="s">"button button-red"</span><span class="nt">&gt;</span>Button Red<span class="nt">&lt;/a&gt;</span>
                            </code>
                        </div>
                        <h2>Block Button</h2>
                        ...
                        <p>
                            ...
                            <a href="#" class="button button-red wide">Button Orange</a>
                        </p>
                        <p>Struktur HTML:</p>
                        <div class="highlight">
                            <code class="language-html">
...
<span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">class=</span><span class="s">"button button-red wide"</span><span class="nt">&gt;</span>Button Red<span class="nt">&lt;/a&gt;</span>
                            </code>
                        </div>
