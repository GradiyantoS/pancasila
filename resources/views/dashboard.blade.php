					...
					<div class="row">
							...
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										<i class="icon icon-widget-performance"></i>
										<span class="label">
											<span class="title">Widget Performance</span>
											<span class="pre-title">Widget Subtitle</span>
										</span>
									</span>
								</div>
							...
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										...
										<span class="label">
											<span class="title">Widget Wheel Meter</span>
											<span class="pre-title">Widget Subtitle</span>
										</span>
									</span>
								</div>
							...
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										<i class="icon icon-widget-performance"></i>
										<span class="label">
											<span class="title">Widget Performance Meter</span>
											<span class="pre-title">Widget Subtitle</span>
										</span>
									</span>
								</div>
						...
						<div class="column one-third">
							<div class="widget">
								...
								<div class="widget-body">
									<div class="widget-scrolled scrolled-horizontal with-change-label" data-show="1">
										<div class="widget-wheel-meter scrolled-item" data-title="Widget Description 1">
											<div class="wheel-meter" data-value="80" data-scale="100">
												<!-- widget goes here -->
												<span class="wheel-legend">
													<span class="score">80</span>
										...
										<div class="widget-wheel-meter scrolled-item" data-title="Widget Description 2">
											<div class="wheel-meter" data-value="80" data-scale="100">
												<!-- widget goes here -->
												<span class="wheel-legend">
										...
										<div class="widget-wheel-meter scrolled-item" data-title="Widget Description 3">
											<div class="wheel-meter" data-value="80" data-scale="100">
												<!-- widget goes here -->
												<span class="wheel-legend">
							...
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										...
										<span class="label">
											<span class="title">Widget Scrollbar</span>
											<span class="pre-title">Widget Subtitle</span>
										</span>
									</span>
								</div>
						...
						<div class="column two-thirds">
							<div class="widget">
								...
								<div class="widget-body">
									<div class="body-sub-title">Lorem ipsum dolor sit amet</div>
									<div class="group-item">
										<div class="item">
							...
							<div class="widget auto-height">
								<div class="widget-head">
									<span class="head-wrap">
										...
										<span class="label">
											<span class="title">Widget Auto Height</span>
											<span class="pre-title">Widget Subtitle</span>
										</span>
									</span>
								</div>
						...
						<div class="column one-half">
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										<span class="label">
											<span class="title">Google ComboChart</span>
										</span>
								...
								<div class="widget-body">
									<div class="widget-google-combochart">
										<div class="google-chart" id="google-combochart"></div>
						...
						<div class="column one-half">
							<div class="widget">
								<div class="widget-head">
									<span class="head-wrap">
										<span class="label">
											<span class="title">Google Piechart</span>
										</span>
										<span class="opposite-link">
											<a href="#">View All</a>
										</span>
								...
								<div class="widget-body">
									<div class="widget-google-piechart">
										...
										<div class="google-chart" id="google-piechart"></div>
										<span class="legend-divider"></span>
									</div>
								</div>
							</div>
