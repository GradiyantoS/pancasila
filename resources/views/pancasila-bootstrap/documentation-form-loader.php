			...
			<div class="container">
				<div class="box-container">
                    <div class="single-content">
						...
						<p>Contoh tampilan pada popup: <a href="documentation-form-loader.php #target-id" class="fancybox-trigger fancybox.ajax">Klik disini</a>.</p>
						...
						<ul style="margin-top: -10px;">
							<li><a href="documentation-form-loader.php #target-id-2" class="fancybox-trigger fancybox.ajax">Contoh status Success</a></li>
							<li><a href="documentation-form-loader.php #target-id-3" class="fancybox-trigger fancybox.ajax">Contoh status Failed</a></li>
						</ul>
