...
var $F = {	
	alertSuccess: function (msg,place){    
        $(place).before('<div class="alert is-success" role="alert">'+msg+'</div>');        
        setTimeout(function() {
	...
	// contoh cara pakai alert Success
    // $F.alertSuccess(data.txt,'.modalalert');
	
	alertError: function (msg,place){
        $(place).before('<div class="alert is-error" role="alert">'+msg+'</div>');        
        setTimeout(function() {
          $(".alert").fadeTo(500, 0).slideUp(500, function(){
              $(this).remove();
          });
	...
	// contoh cara pakai alert Error
    // $F.alertError(data.txt,'.modalalert');
	
	alertWarning: function (msg,place){
        $(place).before('<div class="alert is-warning" role="alert">'+msg+'</div>');        
        setTimeout(function() {
          $(".alert").fadeTo(500, 0).slideUp(500, function(){
              $(this).remove();
          });
